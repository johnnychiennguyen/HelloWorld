...
public class FileUtil {
	...
	public static void deleteFile(String folder) {
	 ...
	 public static void createFileEdxmlBase64(String file) {
		 try {
			String content = IOUtil.getFileContenntAsString(file);
			byte[] contentB64 =  Base64.getEncoder().encode(content.getBytes());
			FileUtil.writeToFile("E:/test/"+Calendar.getInstance().getTimeInMillis()+".edxml", contentB64, false);
		} catch (Exception e) {
	 ...
	 public static void main(String[] args) {
		 FileUtil.createFileEdxmlBase64("e:/edoc.edxml");
	}
