...
public class NSSGatewayReceiveServiceSoapServiceLocator extends org.apache.axis.client.Service implements com.nss.gateway.service.http.NSSGatewayReceiveServiceSoapService {
    ...
    private java.lang.String Plugin_NSSGateway_NSSGatewayReceiveService_address = "http://123.30.75.134:8079/gw-portlet/api/axis/Plugin_NSSGateway_NSSGatewayReceiveService";
    ...
    public com.nss.gateway.service.http.NSSGatewayReceiveServiceSoap getPlugin_NSSGateway_NSSGatewayReceiveService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.nss.gateway.service.http.Plugin_NSSGateway_NSSGatewayReceiveServiceSoapBindingStub _stub = new com.nss.gateway.service.http.Plugin_NSSGateway_NSSGatewayReceiveServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.nss.gateway.service.http.NSSGatewayReceiveServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.nss.gateway.service.http.Plugin_NSSGateway_NSSGatewayReceiveServiceSoapBindingStub _stub = new com.nss.gateway.service.http.Plugin_NSSGateway_NSSGatewayReceiveServiceSoapBindingStub(new java.net.URL(Plugin_NSSGateway_NSSGatewayReceiveService_address), this);
                _stub.setPortName(getPlugin_NSSGateway_NSSGatewayReceiveServiceWSDDServiceName());
                return _stub;
            }
        }
